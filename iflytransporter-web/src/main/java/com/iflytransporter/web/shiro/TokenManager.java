...
import com.iflytransporter.web.utils.SpringBeanFactory;

public class TokenManager {
	public static final ShiroDbRealm realm = SpringBeanFactory.getBean("shiroDbRealm", ShiroDbRealm.class);
	/**
	 * 获取当前登录的用户User对象
	 * @return
	 */
